package com.lanmao.data.sync.redis;
...
public class RedisUtils {
    ...
    private static RedisTemplate<String, CacheValueWrapper<Object>> getRedisTemplate() {
     ...
     * @param value 键值对
     */
    public static <T> void hset(String key, String valueKey, T value){
        try {
            redisTemplate.opsForHash().put(key, valueKey, wrapper(value));
     ...
     * @param value 键值对
     */
    public static <T> void hset(String key, String valueKey, T value, long expireTime, TimeUnit unit){
        try {
            redisTemplate.opsForHash().put(key, valueKey, wrapper(value));
     ...
     * @return
     */
    public static <V> V hget(String key, String valueKey, Class<V> cls){
        try {
            Object obj = redisTemplate.opsForHash().get(key, valueKey);
            validateType((CacheValueWrapper<Object>) obj, cls);
            return ((CacheValueWrapper<V>)obj).getValue();
        } catch (Exception e) {
            logger.error("redis缓存操作失败", e);
            return null;
        }
