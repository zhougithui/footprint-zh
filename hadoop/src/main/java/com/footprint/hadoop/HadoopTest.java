...
public class HadoopTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileSystem fs = FileSystem.get(URI.create("hdfs://192.168.106.141:8485/user/root/passwd.txt"), conf);
        // args[0] hdfs://1.0.0.3:9000/user/zyh/passwd.txt
        // args[0] file:///etc/passwd.txt
        FSDataInputStream is = fs.open(new Path("hdfs://192.168.106.141:8485/user/root/passwd.txt"));
